...
def getOptParser():
    ...
    optParser.add_option("--Eahp_e",          type="float",  help="Excitatory AHP reversal potential (mV)")
...
#    optParser.add_option("--ad_i_g_inc",     type="float",  help="After-spike inhibitory increase of leak conductance (nS)")
    ...
    optParser.add_option("--g_AMPA",          type="float",  help="Mean of AMPA connection synaptic conductance (nS)")
#    optParser.add_option("--g_AMPA_std",     type="float",  help="Std. deviation of AMPA connections synaptic conductance (S)")
    ...
    optParser.add_option("--g_GABA_total",    type="float",  help="Mean of GABA connections synaptic conductance (S)")
