 ...
 * integration method.
 * 
 * Description: iaf_gridcells is a non-adaptive, exponential integrate and fire
 * neuron. Refractory properties can be set by AHP currents. The model can
 * receive AMPA, NMDA, and GABA_A synapses.
 * 
 * The membrane potential is given by the following differential equation: C
 *   dV/dt= -g_L(V-E_L)+g_L*Delta_T*exp((V-V_T)/Delta_T) - g_XXXX(t)(V-E_XXXX)
 *           + * I_e
 * 
 * where
 * 
 ...
 * conductances are modeled as a difference of exponentials, peaked at the
 * incoming weight values
 * 
 * Parameters: 
    ...
    public Archiving_Node
{
    ...
    public:        
         ...
         *
         * We need to explicitly include sets of overloaded virtual
         * functions into the current scope.  According to the SUN C++ FAQ,
         * this is the correct way of doing things, although all other
         * compilers happily live without.
         */
