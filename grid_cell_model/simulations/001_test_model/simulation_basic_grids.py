...
stateMon_params = {'withtime' : True, 'interval' : 0.1, 'record_from' : ['V_m', 'I_clamp_AMPA', 'I_clamp_NMDA', 'I_clamp_GABA_A']}
...
ylabel('E cell $V_m$')
subplot(212)
events = nest.GetStatus(stateMon_i)[0]['events']
plot(events_i['times'], events_e['V_m'])
ylabel('I cell $V_m$')
xlabel('Time (ms)')
