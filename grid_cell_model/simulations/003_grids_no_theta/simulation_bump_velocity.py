#
#   simulation_bump_velocity.py
#
#   Main simulation run of the bump velocity vs. current estimation
#
...
for gen_it in range(options.ngenerations):
    ...
    outData['stateMon_times']           = stateMon_Iclamp_i.times
    ...
    outData['stateMon_i_values']        = stateMon_e.values
