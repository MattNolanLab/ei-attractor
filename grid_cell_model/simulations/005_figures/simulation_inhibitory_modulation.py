#
#   simulation_inhibitory_modulation.py
#
#   Main simulation run: grid fields with velocity modulation onto inhibitory population
#
...
ei_net.setVelocityCurrentInput_i()
