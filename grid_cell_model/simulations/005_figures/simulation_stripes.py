#
#   simulation_stripes.py
#
#   Main simulation run: STRIPE fields with theta input and all the inhibition
...
# Here disable velocity inputs in the X direction, so as to produce stripes 
# parallel to X
prefDirs_mask_e = np.ndarray(ei_net.prefDirs_e.shape)
prefDirs_mask_e[:, :] = 1.0
prefDirs_mask_e[:, 0] = 0.0
ei_net.setVelocityCurrentInput_e(prefDirs_mask=prefDirs_mask_e)
