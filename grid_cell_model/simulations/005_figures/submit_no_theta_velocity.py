#
#   submit_no_theta_velocity.py
#
#   Submit job(s) to the cluster/workstation: velocity estimation for the non-theta variant
#
...
programName         = 'python2.6 simulation_no_theta_velocity.py'
blocking            = False

# Cluster parameters
cluster_scriptName  = 'eddie_submit.sh simulation_no_theta_velocity.py'
