#
#   simulation_placeThetaDriftPhase.py
#
#   Main simulation run: Place cell input is theta modulated, analysis of drift,
#                        depending on the phase of theta modulation
#
...
ei_net.setStartCurrent(force_pos=[0.0, 0.0])
