#
#   submit_placeThetaDriftPhase.py
#
...
#parameters['thetaPlacePhase']   = np.pi/2 # rad

parameters['Iplace']            = 30 # pA
...
programName         = 'nice python2.6 simulation_placeThetaDriftPhase.py'
blocking            = False

# Cluster parameters
cluster_scriptName  = 'eddie_submit.sh simulation_placeThetaDriftPhase.py'
...
iterparams = {
    "thetaPlacePhase" : np.arange(0, np.pi, np.pi/10)
