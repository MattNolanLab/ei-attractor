...
if (grids0):
    ...
    ax = fig.add_axes(Bbox.from_extents(sweepLeft, sweepBottom, sweepRight,
        sweepTop))
    ax, cax = drawGridSweeps(ax, gridDataSpace0, iterList, NTrials=NTrials, r=1,
            c=2, xLabelOn=False, exRows=exRows, exCols=exCols, xticks=False)
    if (grid_examples):
        exLeft = 2
        exBottom = 25
