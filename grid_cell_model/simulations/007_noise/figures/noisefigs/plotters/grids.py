...
class GridExampleRectPlotter(FigurePlotter):
    ...
    def drawSweep(self, ax, dataSpace, iterList, spaceRect, exIdx=(0, 0)):
    ...
    def drawA4RectExamples(self, dataSpace, noise_sigma, iterList, exRect,
                           exIdx, letter=''):
        ...
        self.drawSweep(ax_sweeps, dataSpace, iterList, exRect, exIdx)
        ...
        gs = examples.drawGridExamples(dataSpace, exRect, iterList,
        ...
        for noise_idx, noise_sigma in enumerate(ps.noise_sigmas):
            for exampleIdx, RC in enumerate(exampleRC[noise_idx]):
                ...
                exRect = [exLeft, exBottom, exLeft+exWidth-1,
                          exBottom + exHeight - 1]
                self.drawA4RectExamples(ps.grids[noise_idx], noise_sigma,
                                        iter_list, exRect, YXRC[noise_idx],
