...
for E~$\rightarrow$~I connections $\gGABAA = 0$. \todo{Comment here on E-E, I-I
connections.}
...
\todo[inline]{Describe profiles for E-E, I-I, probabilistic connections, and
unstructured E-I-E.}
\todo[inline]{Describe I-surrounds configuration.}
...
\todo[inline]{Always targeted to E cells.}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\todo[inline]{Add spatial information/sparsity.}
...
\begin{figure}[p]
    ...
    \caption{\todo[inline]{Legend of information scores for the default grid
    simulations.}}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{\todo[inline]{Legend of default I gridness scores.}}
\end{figure}
...
\begin{figure}[p]
    ...
    \todo[inline]{Legend of probabilistic I field examples.}}
\end{figure}
...
\begin{figure}[p]
    ...
    \todo[inline]{I$\rightarrow$I grid examples caption.}
    \todo[inline]{Update main figure legend.}}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{\todo[inline]{Grids in E$\rightarrow$E networks. Caption.}}
\end{figure}
...
\begin{figure}[p!]
    ...
    \caption{\todo[inline]{Sweep and raster plot illustrations for unstructured
    E-I-E connections.}}
\end{figure}
