...
\begin{figure}[p]
    ...
    \caption{\todo[inline]{Gamma with probabilistic connections.}}
\end{figure}
...
\begin{figure}[p]
    ...
    \caption{\todo[inline]{Bumps with probabilistic connections.}
        \todo[inline]{Rescale the figure properly.}
        \todo[inline]{Add contours when grids are finished.}}
\end{figure}
