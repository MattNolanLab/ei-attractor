...
\begin{figure}[p]
    \internallinenumbers
    \centering
        \includegraphics[width=0.95\textwidth]{fig/output_figures/figure2S_grids_examples_default_i_fields}
    \caption{Firing fields of I cells. (A-C) Example
    ...
    \todo[inline]{Legend of default I field examples.}}
\end{figure}
...
\begin{figure}[p]
    \internallinenumbers
    \centering
        \includegraphics[width=0.95\textwidth]{fig/output_figures/figure2S_grids_examples_prob_conn_i_fields}
