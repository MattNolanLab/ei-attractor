...
% Set this to true if you also want to include figures in the PDF
\newtoggle{withFigures}
\settoggle{withFigures}{false}
...
%Since a different input was
%used to oppose attractor drift in the previous version of the model (cf.
%\citet{Pastoll:2013ff}),
...
\iftoggle{withFigures} {
% Use figures if this is true. You need the files put in correct paths to do
% this. Use only when compiling the combined manuscript+SI PDF file.
...
\begin{figure}[ht!]
    \internallinenumbers
    \centering
        \includegraphics{fig/output_figures/Figure4_S1}
    \caption{}
\end{figure}
