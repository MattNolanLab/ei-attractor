...
%f = activeElectrodeCompensation(Vm, Iin, t);

conv_T = 100e-3;
f_T = 4e-3;
step = zeros(1, numel(0:dt:conv_T));
step(1e-3/dt:end) = 1;% + randn(1, numel(step(1e-3/dt:end)));

subplot(3, 1, 1);
plot(0:dt:conv_T, step);
subplot(3, 1, 2);
plot(0:dt:f_T-dt, f(1:end));
subplot(3, 1, 3);
plot(0:dt:conv_T+f_T-dt, conv(step, f(1:end)));