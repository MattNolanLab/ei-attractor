% Network activity dependent on the strength of inhibitory synaptic weights
...
param_i = 1;
wi_vec = [15 20 25 30 35 40 45 50 55 60 65 70]*1e-3 / N
opt.wi_vec = wi_vec;
for wi = wi_vec
    opt.wi = wi;
    wi
...
clear tmpresults;
save('-v7.3', ['i_synaptic_weight_output_' date '_001.mat']);
