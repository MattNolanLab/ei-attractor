...
Ie_all = 23.05e-3; %[18.6 18.8 19.2 19.6 19.8] .* 1e-3; 
find_eps = 1e-9;
...
for Ie = Ie_all
    ...
    print('-depsc2', sprintf('%s/e_input_current_power_spectrum_detail_Ie_%.3fmV.eps', outputDir, opt.Ie_max*1000));
    ...
    set(gcf,'PaperPositionMode','auto');
    print('-depsc2', sprintf('%s/e_input_current_power_spectrum_average_Ie_%.3fmV.eps', outputDir, opt.Ie_max*1000));
    ...
    set(gcf,'PaperPositionMode','auto');
    print('-depsc2', sprintf('%s/e_input_current_population_detail_Ie_%.3fmV.eps', outputDir, opt.Ie_max*1000));
