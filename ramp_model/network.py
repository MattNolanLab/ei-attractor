...
class GammaNetwork:
    ...
    def __init__(self, options):
        ...
        neuron_params_e = {"V_m"              : self.o.E_L_e,
                           "C_m"              : self.o.C_m_e,
                           "t_ref"            : self.o.t_ref_e,
                           "V_peak"           : self.o.V_peak_e,
                           "V_reset"          : self.o.V_reset_e,
                           "E_L"              : self.o.EL_e,
                           "g_L"              : self.o.gL_e,
        ...
        self.nodes_ex    = nest.Create(model_name, self.o.Ne, params = neuron_params_e)
        self.nodes_in    = nest.Create(model_name, self.o.Ni, params = neuron_params_i)
        self.receptors   = nest.GetDefaults(model_name)['receptor_types']
    ...
    def connRandom(self):
        ...
        g_GABA_A_mean = self.o.g_GABA_total / self.net_Ni / self.o.GABA_density
